...
# We could choose the appropriate games and change the 6th column value to 0 after the function has been executed.
...
Data2Mat = function(df){
  # Data frame should have the columns 'Team.A', 'Team.B', 'Team.A.win', 'Team.B.win', 'Team.A.Home', 'Team.B.Home'
