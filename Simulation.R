...
#Model is the model we have used to obatin probabilities
#R is the relationship matrix

Seeds_East = function(Seeds){
#Seeds_East takes the output from PlayInTournament() and gives the appropraie seeding for the 10 teams in the East.
...
#df is the fixture list of the Eastern Conference playoffs without the play-in teams added. Team A has the higher seed in this fixture list.
...
Seeds_West = function(Seeds){
  #Seeds_Wast takes the output from PlayInTournament() and gives the appropraie seeding for the 10 teams in the West. An example of
...
#df is the fixture list of the Western Conference playoffs without the play-in teams added. Team A has the higher seed in this fixture list.
#Probabilities is the results of BT_predict for the entire season
#SE is the Seeds of the Eastern Conference obtained from Seeds_East
  p <- df
  p[1,2] <- SW[8,2]
...
#df is the out put from the function Final(), which adjusts the seeding to show home ground advantage
  p <- df
  p$Home_Win <- NA
  p$Winner <- NA
  for (i in 1:nrow(p)){
